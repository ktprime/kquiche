...
inline constexpr QuicByteCount kMtuDiscoveryTargetPacketSizeHigh = kEthernetMTU - 100;
inline constexpr QuicByteCount kMtuDiscoveryTargetPacketSizeLow = kMtuDiscoveryTargetPacketSizeHigh - 20;

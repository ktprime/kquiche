...
#define QUICHE_BUG_IMPL(b) QUICHE_LOG(FATAL) << #b ": "
#define QUICHE_BUG_IF_IMPL(b, condition) \
  QUICHE_LOG_IF(FATAL, condition) << #b ": "
#define QUICHE_PEER_BUG_IMPL(b) QUICHE_LOG(FATAL)
#define QUICHE_PEER_BUG_IF_IMPL(b, condition) QUICHE_LOG_IF(FATAL, condition)
